        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>No Change</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="nc_edit_cat.jsp" class="btn btn-outline dark fancyBoxRaf"><i class="fa fa-plus-circle"></i> New Category</a>
                                <a href="nc_viewbranch.jsp" class="btn btn-outline dark" target="_blank" ><i class="fa fa-wrench"></i> View Branch</a>  
                                <a href="nc_viewcat.jsp" class="btn btn-outline dark" target="_blank" ><i class="fa fa-map-o"></i> View Category</a>  
                                <!--
                                <a href="nc_macro.jsp" class="btn btn-outline dark" target="_blank" ><i class="fa fa-anchor"></i> View Macro</a>  
                                <a href="nc_department.jsp" class="btn btn-outline dark" target="_blank" ><i class="fa fa-print"></i> View Fiscal Department</a>  
                                -->
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">    
                                                    ...
                                                    <a href="nc_category.jsp" class="btn btn-outline red"><i class="fa fa-trash-o"></i> Reset</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form action="nc_category.jsp" method="post" name="f1">
                        <input type="hidden" name="search" value="<%=Utility.sanitize(search)%>">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="portlet box green">
                                    <div class="portlet-title">
                    ...
                    <div class="row">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Category</span>
                                    </div>
                                    <div class="actions">
                                                        ...
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="tabnow" style="width: 70px;">Status</th>
                        ...
                        <%
                            ...
                            if (show.length() == 20 && !codnc.equals("")) {
                                ...
                                NC_category nc1 = Engine.getNC_category(codnc);
                        %>
                        <div class="col-md-6">
                            ...
                            <div class="portlet box blue-dark">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-bar-chart"></i>
                                        <span class="caption-subject">Category: <%=Utility.sanitize(nc1.getGruppo_nc())%> - <%=Utility.sanitize(nc1.getDe_gruppo_nc())%></span>
                                    </div>
                                    <div class="actions">
                                        <%if(central&&tipo.equals("3") &&nc1.getAnnullato().equals("0")){%>
                                        <a href="nc_edit_cas.jsp?nc_cat=<%=Utility.sanitize(nc1.getGruppo_nc())%>" class="btn btn-sm btn-outline white fancyBoxRaf"><i class="fa fa-plus-circle"></i> New Causal</a>
                                        <%}%>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="portlet box blue-dark">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-bar-chart"></i>
                                        <span class="caption-subject">Results - Causal </span>
                                    </div>
                                ...
                                jQuery(document).ready(function () {
                                    var dt1 = function () {
                                        ...
                                        f.dataTable({
                                            ...
                                            scrollY: true,
                                            ajax: {
                                                url: "Query?type=nc_cat&kind_1=<%=Utility.sanitize(request.getParameter("kind_1"))%>&search=<%=Utility.sanitize(request.getParameter("search"))%>",
                                                                    dataSrc: "aaData",
                                                                    type: "GET"
                                                                },
                                              ...
                                              {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            ...
                                                                            window.open('Fileview?type=nc_category_cat&kind_1=<%=Utility.sanitize(request.getParameter("kind_1"))%>&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            ...
                                                                            window.open('Fileview?type=nc_category_cat&kind_1=<%=Utility.sanitize(request.getParameter("kind_1"))%>&value=pdf', '_blank');
                                                                        }
                                                                    },
                    ...
                    jQuery(document).ready(function () {
                        var dt2 = function () {
                            ...
                            g.dataTable({
                                ...
                                scrollY: true,
                                ajax: {
                                    url: "Query?type=nc_caus&codnc=<%=Utility.sanitize(request.getParameter("codnc"))%>&search=<%=Utility.sanitize(request.getParameter("search"))%>",
                                                        dataSrc: "aaData",
                                                        type: "GET"
                                                    },
                                                    initComplete: function (settings, json) {
                                              ...
                                              {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            //window.open('Download?type=viewExcel&cod=' + cexcel, '_blank');
                                                                            window.open('Fileview?type=nc_category_cas&codnc=<%=Utility.sanitize(request.getParameter("codnc"))%>&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        className: "btn white btn-outline",
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            //window.open('Download?type=viewPdf&cod=' + cpdf, '_blank');
                                                                            window.open('Fileview?type=nc_category_cas&codnc=<%=Utility.sanitize(request.getParameter("codnc"))%>&value=pdf', '_blank');
                                                                        }
                                                                    },
                                                {extend: "colvis", className: "btn white btn-outline", text: "<i class='fa fa-list-alt'></i> Columns"},
                                                {text: "<i class='fa fa fa-refresh'></i>",
