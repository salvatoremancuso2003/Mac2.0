...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Fix Commission</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma14.jsp"%>
            <!-- END MENU -->
            <%
                ...
                ArrayList<String[]> array_fix = Engine.fixed_commission_range();
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Fix Commission</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_fixcomm.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Fix Commission</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    for (int i = 0; i < array_fix.size(); i++) {%>
                                                                <tr>
                                                                    <td><%=Utility.formatAL(array_fix.get(i)[0], array_kind, 1)%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(array_fix.get(i)[1])%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(array_fix.get(i)[2])%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(array_fix.get(i)[3])%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(array_fix.get(i)[4])%></td>
                                                                    <td><%=Engine.formatStatus_general(array_fix.get(i)[5])%></td>
                                                                    <td>
                                                                        <%if (central && tipo.equals("3")) {%>
                                                                        <a href="tb_edit_fixcomm.jsp?fil=<%=fil%>&fi_code=<%=array_fix.get(i)[0]%>&fi_min=<%=array_fix.get(i)[1]%>&fi_max=<%=array_fix.get(i)[2]%>" 
                                                                           class="btn btn-sm blue btn-outline btn-circle fancyBoxRafreload"><i class="fa fa-wrench"></i> Edit
                                                                        </a>
                                                                        <%}%>
                                                                    </td>
                                                                </tr>  
                    ...
                    <%if (central) {
                            ...
                            if (search == null) {%>
                    <form action="tb_fixcomm.jsp" method="post">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <a href="tb_fixcomm.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body">
                                ...
                                <%
                                    ...
                                    ArrayList<String[]> array_fix_list = Engine.fixed_commission_range(request.getParameter("branch"));
                                        ...
                                        <div class="portlet">
                                            ...
                                            <div class="portlet-body">
                                                <table class="table table-responsive table-bordered table-hover" id="sample_1" width="100%">
                                                    ...
                                                    <tbody>
                                                        <%                                                                    for (int i = 0; i < array_fix_list.size(); i++) {%>
                                                        <tr>
                                                            <td><%=Utility.sanitize(Utility.formatAL(array_fix_list.get(i)[0], array_kind, 1))%></td>
                                                            <td><%=Utility.formatMysqltoDisplay(Utility.sanitize(array_fix_list.get(i)[1]))%></td>
                                                            <td><%=Utility.formatMysqltoDisplay(Utility.sanitize(array_fix_list.get(i)[2]))%></td>
                                                            <td><%=Utility.formatMysqltoDisplay(Utility.sanitize(array_fix_list.get(i)[3]))%></td>
                                                            <td><%=Utility.formatMysqltoDisplay(Utility.sanitize(array_fix_list.get(i)[4]))%></td>
                                                            <td><%=Utility.sanitize(Engine.formatStatus_general(array_fix_list.get(i)[5]))%></td>
                                                            <td><a href="tb_edit_fixcomm.jsp?fil=<%=Utility.sanitize(request.getParameter("branch"))%>&fi_code=<%=Utility.sanitize(array_fix_list.get(i)[0])%>&view=1&fi_min=<%=Utility.sanitize(array_fix_list.get(i)[1])%>&fi_max=<%=Utility.sanitize(array_fix_list.get(i)[2])%>" 
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_fixcomm&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_fixcomm&value=pdf', '_blank');
                                                    }
                                                },
