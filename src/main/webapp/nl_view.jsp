                                ...
                                jQuery(document).ready(function () {
                                    var dt1 = function () {
                                        ...
                                        f.dataTable({
                                            ...
                                            ajax: {
                                                url: "Query?type=newsletter&status=<%=Utility.sanitize(request.getParameter("status"))%>",
                                                dataSrc: "aaData",
                                                type: "GET"
                                            },
                                            columnDefs: [
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                           
                                                                            ...
                                                                            window.open('Fileview?type=nlview&status=<%=Utility.sanitize(request.getParameter("status"))%>&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        ...
                                                                        action: function (e, dt, node, config) {                                                                         
                                                                            ...
                                                                            window.open('Fileview?type=nlview&status=<%=Utility.sanitize(request.getParameter("status"))%>&value=pdf', '_blank');
                                                                        }
                                                                    },
