var ComponentsDateTimePickers = function () {
    ...
    var handleDatetimePicker = function () {
        ...
        $(".form_datetimeSEC").datetimepicker({
            autoclose: true,
            isRTL: App.isRTL(),
        ...
        $(document).scroll(function () {
            $('#form_modal1 .form_datetime, #form_modal1 .form_datetimeSEC, #form_modal1 .form_advance_datetime, #form_modal1 .form_meridian_datetime').datetimepicker('place'); //#modal is the id of the modal
        });
    }
