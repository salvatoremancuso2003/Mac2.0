                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>User</label>
                                <input type="text" class="form-control" disabled="disabled" value="<%=Utility.sanitize(list_kyc_modified.get(x).getUsermodifica())%>"/>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date</label>
                                <input type="text" class="form-control" disabled="disabled" value="<%=Utility.sanitize(Utility.formatStringtoStringDate(list_kyc_modified.get(x).getDatemodifica(), Constant.patternsqldate, Constant.patternnormdate))%>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <table class="table table-responsive table-bordered table-responsive">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td class="tabnow font-blue"><%=Utility.sanitize(s1)%></td>
                                        <td class="font-red"><%=Utility.sanitize(s2[0])%></td>
                                        <td class="font-green-dark"><%=Utility.sanitize(s2[1])%></td>
                                    </tr>
                                    <%
