            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_figur" onsubmit="return checkdescr();">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View Error Description</span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" onkeypress="return keysub(this, event);"
                                                           value="<%=Utility.sanitize(va[1])%>" readonly="readonly" /> 
                                                </div>
                                            </div>
                                            <div class="form-group" id="ex3">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" id="sel_com" name="sel_com" 
                                                           ...
                                                           value="<%=Utility.sanitize(va[2])%>"readonly="readonly" /> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        %>
                        <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_wb_error" onsubmit="return checkdescr();">
                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-blue bold uppercase">Edit Error Description</span>
                                            </div>
                                            <div class="tools"> 
                                                <div class="form-group">
                                                <div class="row">
