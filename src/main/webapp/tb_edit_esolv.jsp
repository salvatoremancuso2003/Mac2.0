...
<html lang="en">
    ...
    <body class="page-full-width page-content-white" onload="return inputvirgola();">
     ...
     %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_accode" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit Accounting Code</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" id="cod" name="cod" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(es_code)%>" readonly="readonly"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(descr)%>" onkeyup="return fieldNOSPecial_2(this.id);" maxlength="100"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Accounting Code</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="acc" name="acc" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(contcode)%>" onkeyup="return fieldOnlyNumber(this.id);" maxlength="10" /> 
                                                </div>
                                            </div>
