...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma19.jsp"%>
            <!-- END MENU -->
            <%                
                ...
                ArrayList<String[]> array_rate = Engine.rate_range(fil);
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Level Rate</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_raterange.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Level Rate</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <%                                                                    for (int i = 0; i < array_rate.size(); i++) {%>
                                                                <tr>
                                                                    <td><%=Utility.formatAL(array_rate.get(i)[0], array_kind, 1)%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(array_rate.get(i)[1])%></td>
                                                                    <td><%=Utility.formatMysqltoDisplay(array_rate.get(i)[2])%></td>
                                                                    <td><%=Utility.formatAL(array_rate.get(i)[3], level_rate, 1)%></td>
                                                                    <td><%=Utility.formatAL(array_rate.get(i)[4], level_rate, 1)%></td>
                                                                    <td><%=Engine.formatStatus_general(array_rate.get(i)[5])%></td>
                                                                    <td>
                                                                        <%if (central && tipo.equals("3")) {%>
                                                                        <a href="tb_edit_raterange.jsp?fil=<%=fil%>&view=0&ra_code=<%=array_rate.get(i)[0]%>&ra_min=<%=array_rate.get(i)[1]%>" 
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <a href="tb_raterange.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="portlet">
                                            ...
                                            <div class="portlet-body">
                                                <table class="table table-responsive table-bordered table-hover" id="sample_1" width="100%">
                                                    ...
                                                    <tbody>
                                                        <%                                                                    for (int i = 0; i < array_rate_list.size(); i++) {%>
                                                        <tr>
                                                            <td><%=Utility.sanitize(Utility.formatAL(array_rate_list.get(i)[0], array_kind, 1))%></td>
                                                            <td><%=Utility.sanitize(array_rate_list.get(i)[1])%></td>
                                                            <td><%=Utility.sanitize(array_rate_list.get(i)[2])%></td>
                                                            <td><%=Utility.sanitize(Utility.formatAL(array_rate_list.get(i)[3], level_rate, 1))%></td>
                                                            <td><%=Utility.sanitize(Utility.formatAL(array_rate_list.get(i)[4], level_rate, 1))%></td>
                                                            <td><%=Utility.sanitize(Engine.formatStatus_general(array_rate_list.get(i)[5]))%></td>
                                                            <td><a href="tb_edit_raterange.jsp?fil=<%=Utility.sanitize(request.getParameter("branch"))%>&view=1&ra_code=<%=Utility.sanitize(array_rate_list.get(i)[0])%>&ra_min=<%=Utility.sanitize(array_rate_list.get(i)[1])%>" 
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_raterange&filiale=<%=Engine.getFil()[0]%>&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_raterange&filiale=<%=Engine.getFil()[0]%>&value=pdf', '_blank');
                                                    }
                                                },
                            ...
                            f.dataTable({
                                ...
                                buttons: [
                                    {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                        ...
                                        action: function (e, dt, node, config) {
                                            //window.open('Download?type=viewExcel&cod=' + cexcel, '_blank');
                                            window.open('Fileview?type=tb_raterange&filiale=<%=Utility.sanitize(request.getParameter("branch"))%>&value=excel', '_blank');
                                        }
                                    },
                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                        className: "btn blue-hoki btn-outline",
                                        action: function (e, dt, node, config) {
                                            //window.open('Download?type=viewPdf&cod=' + cpdf, '_blank');
                                            window.open('Fileview?type=tb_raterange&filiale=<%=Utility.sanitize(request.getParameter("branch"))%>&value=pdf', '_blank');
                                        }
                                    },
