                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           name="kind0" id="kind0" value="<%=Utility.sanitize(Utility.formatAL(fix_value[3], array_kind, 1))%>" 
                                                           disabled="disabled"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control"id="max" name="max" maxlength="11"
                                                           disabled="disabled"
                                                           value="<%=Utility.sanitize(fix_value[2])%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="sell" name="sell" maxlength="11"
                                                           disabled="disabled"
                                                           value="<%=Utility.sanitize(fix_value[3])%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           name="kind0" id="kind0" value="<%=Utility.sanitize(Utility.formatAL(fix_value[0], array_kind, 1))%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
