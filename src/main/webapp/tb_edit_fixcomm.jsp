            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View Fix Commission - Branch: <%=Utility.sanitize(fil)%></span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           name="kind0" id="kind0" value="<%=Utility.sanitize(Utility.formatAL(fi_code, array_kind, 1))%>" 
                                                           disabled="disabled"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="buy" name="buy" maxlength="11"
                                                           disabled="disabled"
                                                           value="<%=Utility.sanitize(fix_value[0])%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="sell" name="sell" maxlength="11"
                                                           disabled="disabled"
                                                           value="<%=Utility.sanitize(fix_value[1])%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_comfix" onsubmit="return checkdescr();">
                        ...
                        <input type="hidden" name="fi_code" value="<%=Utility.sanitize(fi_code)%>"/> 
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
