            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_vatcode" onsubmit="return checkdescr();">
                        <input type="hidden" name="va_id" value="<%=Utility.sanitize(va_code)%>"/>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" id="va_code" name="va_code" value="<%=Utility.sanitize(va.getCodice())%>" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" 
                                                           ...
                                                           maxlength="100" value="<%=Utility.sanitize(va.getDescrizione())%>" /> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="esol" name="esol" 
                                                           ...
                                                           value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(va.getAliquota()))%>"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
