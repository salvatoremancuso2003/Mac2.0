...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_li6.jsp"%>
            <!-- END MENU -->
            <%
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">List <small><b>K.Y.C. Declaration</b></small></h3>
                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="cl_cog" name="cl_cog" onkeyup="return fieldNameSurname(this.id);"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Client Name</label>
                                                        <input type="text" class="form-control" id="cl_na" name="cl_na" onkeyup="return fieldNameSurname(this.id);"/>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="kyc_list.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Client Surname</label>
                                                        <input type="text" class="form-control" id="cl_cog" name="cl_cog" value="<%=Utility.sanitize(request.getParameter("cl_cog"))%>" onkeyup="return fieldNameSurname(this.id);"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Client Name</label>
                                                        <input type="text" class="form-control" id="cl_na" name="cl_na" value="<%=Utility.sanitize(request.getParameter("cl_na"))%>" onkeyup="return fieldNameSurname(this.id);"/>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-md-3">
                                            ...
                                            <table class="table table-bordered" id="sample_1" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="tabnow">BranchID</th>
                                                        <th class="tabnow">Client Surname</th>
                                                        <th class="tabnow">Client Name</th>
                                                        <th class="tabnow">Motivation</th>
                                                        <th class="tabnow">Document Date</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                                                        ...
                                                        jQuery(document).ready(function () {
                                                            var dt2 = function () {
                                                                ...
                                                                g.dataTable({
                                                                    ...
                                                                    ajax: {
                                                                        url: "Query?type=kyc_list&cl_cog=<%=Utility.convertApici(Utility.sanitize(request.getParameter("cl_cog")))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&cl_na=<%=Utility.convertApici(Utility.sanitize(request.getParameter("cl_na")))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>",
                                                                        dataSrc: "aaData",
                                                                        type: "GET"
                                                                    },
                                                                    ...
                                                                    buttons: [
                                                                        ...
                                                                        {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                            ...
                                                                            action: function (e, dt, node, config) {
                                                                                window.open('Fileview?type=kyc_list&cl_cog=<%=Utility.convertApici(Utility.sanitize(request.getParameter("cl_cog")))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&cl_na=<%=Utility.convertApici(Utility.sanitize(request.getParameter("cl_na")))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=excel', '_blank');
                                                                            }
                                                                        },
                                                                        {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                            className: "btn white btn-outline",
                                                                            action: function (e, dt, node, config) {
                                                                                window.open('Fileview?type=kyc_list&cl_cog=<%=Utility.convertApici(Utility.sanitize(request.getParameter("cl_cog")))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&cl_na=<%=Utility.convertApici(Utility.sanitize(request.getParameter("cl_na")))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=pdf', '_blank');
                                                                            }
                                                                        },
