...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript">
            function checkdescr() {
                var di_code = document.getElementById("doc_code").value.trim();
                var descr = document.getElementById("descr").value.trim();
                var oam = document.getElementById("oam").value.trim();
                if (di_code === "" || descr === "" || oam === "") {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_doctype" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit Identity Document</span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           id="doc_code"name="doc_code" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(doc_code)%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control"  id="descr" name="descr" onkeypress="return keysub(this, event);"
                                                           value="<%=Utility.sanitize(descr)%>"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">OAM Code</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="oam" name="oam" onkeypress="return keysub(this, event);" maxlength="2"
                                                           value="<%=Utility.sanitize(oam)%>"> 
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <%} else {%>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_newdoctype" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">New Identity Document</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Code</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" id="doc_code"name="doc_code" onkeypress="return keysub(this, event);"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
