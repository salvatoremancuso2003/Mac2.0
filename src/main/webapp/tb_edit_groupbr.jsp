            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_groupbr" onsubmit="return checkdescr();">
                        <input type="hidden" name="typegr" value="<%=Utility.sanitize(type)%>"/>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit Branch Group</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" name="gr_code" value="<%=Utility.sanitize(gr_code)%>"  maxlength="3"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" value="<%=Utility.sanitize(typedes)%>" 
                                                           onkeypress="return keysub(this, event);" readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <%} else {
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_groupbr" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">New Branch Group</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Code</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control uppercase" id="gr_code" name="gr_code" onkeypress="return keysub(this, event);" maxlength="3"> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Type</label>
                                            <div class="col-md-9">
                                                <select class="form-control select2" id="typegr" name="typegr" data-container="body" onkeypress="return keysub(this, event);">
                                                    <%for (int i = 0; i < list_type.size(); i++) {%>
                                                    <option value="<%=list_type.get(i)[0]%>"><%=list_type.get(i)[1]%></option>
                                                    <%}%>
                                                </select>
                                            </div>
                                        </div>
