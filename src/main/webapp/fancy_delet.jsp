        ...
        <script type="text/javascript">
            function checkdescr() {
                ...
                if (motiv1 === "") {
                    ...
                    document.getElementById('errorlargetext').innerHTML = "Field 'Motivation' must be completed.";
                    return false;
                }
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    String tobr = request.getParameter("tobr");
                        if (code != null) {%>
                    <form id="deletetrmod" name="deletetrmod" action="Operazioni?type=del_etr" method="post" onsubmit="return checkdescr();">
                        <div class="modal-header">
                            <h4 class="modal-title">Delete Transaction</h4>
                        </div>
                        <div class="modal-body">
                            <%if(tobr!=null && tobr.equals("true")){%>
                            <div class="alert alert-danger bold">
                                <p>Before proceeding with the cancellation, verify that the branching has not already been acquired by the destination branch.</p>
                                <p>Please, inform the destination branch that this branching will not be acquired.</p>
                            </div>
                            <hr>
                            <%}%>
                            
                            <div class="form-group form-md-line-input form-md-floating-label">
                                <input class="form-control"  type="text" maxlength="100" name="motiv1" id="motiv1" onkeyup="return fieldNOSPecial_2(this.id);"/>
                                <label for="form_control_1">Motivation</label>
                            </div>
                        </div>
                        <div class="modal-footer">
