...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return loadpage();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_li1.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">List <small><b>Open/Close</b></small></h3>
                        </div>
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control select2" id="till" name="till">
                                                                ...
                                                                <option value="<%=array_till.get(i)[0]%>"><%=array_till.get(i)[1]%></option>
                                                                <%}%>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="oc_list.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table table-bordered" id="sample_1" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th class="tabnow" style="width: 50px;">Actions</th>
                                                        ...
                                                        <th class="tabnow" style="width: 100px;">Errors</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                        ...
                        jQuery(document).ready(function () {
                            var dt2 = function () {
                                ...
                                g.dataTable({
                                    ...
                                    ajax: {
                                        url: "Query?type=oc_list&till=<%=Utility.sanitize(request.getParameter("till"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&pdf=<%=Utility.sanitize(pdfstr)%>",
                                        dataSrc: "aaData",
                                        type: "GET"
                                    },
                                    ...
                                    buttons: [
                                        {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                            ...
                                            action: function (e, dt, node, config) {
                                                ...
                                                window.open('Fileview?type=oc_list&till=<%=Utility.sanitize(request.getParameter("till"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=excel', '_blank');
                                            }
                                        },
                                        {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                            ...
                                            action: function (e, dt, node, config) {
                                                ...
                                                window.open('Fileview?type=oc_list&till=<%=Utility.sanitize(request.getParameter("till"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=pdf', '_blank');
                                            }
                                        },
