                                                    ...
                                                    <div class="portlet-body">
                                                        ...
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_1" width="100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><%=Utility.sanitize(list_figures.get(i).getSupporto())%></td>
                                                                    <td><%=Utility.sanitize(list_figures.get(i).getDe_supporto())%> </td>
                                                                    <td><a href="tb_edit_figures.jsp?view=1&fil=<%=Utility.sanitize(list_figures.get(i).getFiliale())%>&fi_code=<%=Utility.sanitize(list_all_figures.get(i).getSupporto())%>" 
                                ...
                                buttons: [
                                    {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                        ...
                                        action: function (e, dt, node, config) {
                                            ...
                                            //window.open('Download?type=viewExcel&cod=' + cexcel, '_blank');
                                            window.open('Fileview?type=tb_figures&filiale=<%=Utility.sanitize(request.getParameter("branch"))%>&value=excel', '_blank');
                                        }
                                    },
                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                        className: "btn blue-hoki btn-outline",
                                        action: function (e, dt, node, config) {
                                            ...
                                            //window.open('Download?type=viewPdf&cod=' + cpdf, '_blank');
                                            window.open('Fileview?type=tb_figures&filiale=<%=Utility.sanitize(request.getParameter("branch"))%>&value=pdf', '_blank');
                                        }
                                    },
