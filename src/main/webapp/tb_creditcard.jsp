...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Credit Card</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma10.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Credit Card</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_creditcard.jsp" class="btn btn-outline dark fancyBoxRafreload"><i class="fa fa-plus-circle"></i> New Credit Card</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Credit Card</span>
                                    </div>
                                    <div class="actions">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <a href="tb_creditcard.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-responsive table-bordered table-hover" id="sample_1" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><%=Utility.sanitize(array_cc_list.get(i)[0])%></td>
                                                    <td><%=Utility.sanitize(array_cc_list.get(i)[1])%></td>
                                                    <td><%=Utility.sanitize(Engine.formatStatus_general(array_cc_list.get(i)[2]))%></td>
                                                    <td><a href="tb_edit_creditcard.jsp?fil=<%=Utility.sanitize(request.getParameter("branch"))%>&view=1&cc_code=<%=Utility.sanitize(array_cc_list.get(i)[0])%>" 
                                            ...
                                            buttons: [
                                                 {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                                        ...
                                                                        action: function (e, dt, node, config) {
                                                                            ...
                                                                            //window.open('Download?type=viewExcel&cod=' + cexcel, '_blank');
                                                                            window.open('Fileview?type=tb_creditcard&filiale=<%=Utility.sanitize(request.getParameter("branch"))%>&value=excel', '_blank');
                                                                        }
                                                                    },
                                                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                                        className: "btn blue-hoki btn-outline",
                                                                        action: function (e, dt, node, config) {
                                                                            ...
                                                                            //window.open('Download?type=viewPdf&cod=' + cpdf, '_blank');
                                                                            window.open('Fileview?type=tb_creditcard&filiale=<%=Utility.sanitize(request.getParameter("branch"))%>&value=pdf', '_blank');
                                                                        }
                                                                    },
