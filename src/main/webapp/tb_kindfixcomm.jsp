...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - Kind Fix Commission</title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_ma17.jsp"%>
            <!-- END MENU -->
            <%
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance <small><b>Kind Fix Commission</b></small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="tb_edit_kindfixcomm.jsp" class="btn btn-outline dark fancyBoxRaf"><i class="fa fa-plus-circle"></i> New Kind Fix Commission</a>
                            </div>
                        </div>
                    </div>
                    <%}%>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject">Results - Kind Fix Commission</span>
                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    for (int i = 0; i < array_kindfix.size(); i++) {%>
                                                                <tr>
                                                                    <td><%=array_kindfix.get(i)[0]%></td>
                                                                    <td><%=array_kindfix.get(i)[1]%></td>
                                                                    <td><%=array_kindfix.get(i)[2]%></td>
                                                                    <td><%=Engine.formatStatus_general(array_kindfix.get(i)[3])%></td>
                                                                    <td><%if (central && tipo.equals("3")) {%>
                                                                        <a href="tb_edit_kindfixcomm.jsp?fil=<%=fil%>&ki_code=<%=array_kindfix.get(i)[0]%>" 
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <a href="tb_kindfixcomm.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="portlet">
                                            ...
                                            <div class="portlet-body">
                                                <table class="table table-responsive table-bordered table-hover" id="sample_1" width="100%">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            for (int i = 0; i < array_kindfix_list.size(); i++) {%>
                                                        <tr>
                                                            <td><%=Utility.sanitize(array_kindfix_list.get(i)[0])%></td>
                                                            <td><%=Utility.sanitize(array_kindfix_list.get(i)[1])%></td>
                                                            <td><%=Utility.sanitize(array_kindfix_list.get(i)[2])%></td>
                                                            <td><%=Utility.sanitize(Engine.formatStatus_general(array_kindfix_list.get(i)[3]))%></td>
                                                            <td><a href="tb_edit_kindfixcomm.jsp?view=1&fil=<%=Utility.sanitize(request.getParameter("branch"))%>&ki_code=<%=Utility.sanitize(array_kindfix_list.get(i)[0])%>" 
                                            ...
                                            buttons: [
                                                {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_kindfixcomm&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=tb_kindfixcomm&value=pdf', '_blank');
                                                    }
                                                },
