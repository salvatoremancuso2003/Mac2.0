            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <%
                        ...
                        Figures fi = Engine.get_figures(fi_code, "000");
                        if (fi != null) {
                            
                            String[] va = Engine.get_site_supporti(fi_code);
                    ...
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_figur" onsubmit="return checkdescr();">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View % Commission</span>
                                        </div>
                                        <div class="tools"> 
                        ...
                        %>
                        <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_wb_figur" onsubmit="return checkdescr();">
                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-blue bold uppercase">Edit % Commission</span>
                                            </div>
                                            <div class="tools"> 
                                                <div class="form-group">
                                                <div class="row">
