            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <%
                        ...
                        if (lo_code != null) {
                            ArrayList<String[]> array_undermincommjustify = Engine.undermincommjustify();
                            String descr = Utility.formatAL(lo_code, array_undermincommjustify, 1);
                            String st = Utility.formatAL(lo_code, array_undermincommjustify, 2);
                            String status = "";
                            if (st.equals("0")) {
                                status = "checked";
                            }
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_lowcom" onsubmit="return checkdescr();">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- BEGIN PORTLET-->
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-blue bold uppercase">Edit Low Commission Justify</span>
                                    </div>
                                    <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           id="lo_code"name="lo_code" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(lo_code)%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <%} else {
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_newlowcom" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">New Low Commission Justify</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Code</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control uppercase" readonly="readonly" id="lo_code"name="lo_code" onkeypress="return keysub(this, event);"> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Description</label>
