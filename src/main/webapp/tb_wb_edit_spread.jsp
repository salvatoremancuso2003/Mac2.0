                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-icon">
                                                                <input type="text" class="form-control" 
                                                                       ...
                                                                       value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[3]))%>" />
                                                            </div>
                                                        </div>
                                                    </div>    
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-icon" id="buystd_normal">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       onkeypress="return keysub(this, event);" 
                                                                       value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[4]))%>"maxlength="6"> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-icon">
                                                                ...
                                                                <input type="text" class="form-control" id="buy_l1" name="buy_l1"<%=localnonmod%>
                                                                       onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                       onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[5]))%>"> 
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-icon">
                                                                ...
                                                                <input type="text" class="form-control" id="buy_l2" name="buy_l2"<%=localnonmod%>
                                                                       onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                       onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[6]))%>"> 
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-icon">
                                                                ...
                                                                <input type="text" class="form-control" id="buy_l3" name="buy_l3" <%=localnonmod%>
                                                                       onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                       onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[7]))%>"> 
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-icon">
                                                                ...
                                                                <input type="text" class="form-control" id="buy_best" name="buy_best"<%=localnonmod%>
                                                                       onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                       onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[8]))%>"> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-icon"id="sellstd_per">
                                                                    ...
                                                                    <input type="text" class="form-control" id="sell_std_perc" <%=localnonmod%>
                                                                           name="sell_std_perc" onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[9]))%>"
                                                                           onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                           > 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-icon">
                                                                    ...
                                                                    <input type="text" class="form-control" id="sell_l1" name="sell_l1" 
                                                                           onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                           <%=localnonmod%>  onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[10]))%>"> 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-icon">
                                                                    ...
                                                                    <input type="text" class="form-control" id="sell_l2" name="sell_l2" onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                           <%=localnonmod%> onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[11]))%>"> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-icon">
                                                                    ...
                                                                    <input type="text" class="form-control" id="sell_l3" name="sell_l3" onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                           <%=localnonmod%> onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[12]))%>"> 
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-icon">
                                                                    ...
                                                                    <input type="text" class="form-control" id="sell_be" name="sell_be" 
                                                                           onchange="formatValueDecimalMax(this, '100' + '<%=decimal%>' + '00', '<%=thousand%>', '<%=decimal%>');"
                                                                           <%=localnonmod%>  onkeypress="return keysub(this, event);" value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(valori[13]))%>"> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
