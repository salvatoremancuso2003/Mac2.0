                    ...
                    jQuery(document).ready(function () {
                        var dt2 = function () {
                            ...
                            g.dataTable({
                                ...
                                ajax: {
                                    url: "Query?type=transaction_list_nc&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&nc_cat1=<%=Utility.sanitize(request.getParameter("nc_cat1"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&search=<%=Utility.sanitize(request.getParameter("search"))%>",
                                    dataSrc: "aaData",
                                    type: "GET",
                                    timeout: 12000000
                                },
                                ...
                                buttons: [
                                    {text: "<i class='fa fa-file-pdf-o'></i> Excel",
                                        ...
                                        action: function (e, dt, node, config) {
                                            ...
                                            window.open('Fileview?type=transactionnc_list&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&nc_cat1=<%=Utility.sanitize(request.getParameter("nc_cat1"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=excel', '_blank');
                                        }
                                    },
                                    {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                        ...
                                        action: function (e, dt, node, config) {
                                            ...
                                            window.open('Fileview?type=transactionnc_list&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&nc_cat1=<%=Utility.sanitize(request.getParameter("nc_cat1"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=pdf', '_blank');
                                        }
                                    },
