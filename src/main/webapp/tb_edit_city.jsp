    ...
    <head>
        ...
        <script type="text/javascript">
            function checkdescr() {
                ...
                var cit_code = document.getElementById("cit_code").value.trim();
                if (cit_code === "" || descr === "") {
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_city" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit City</span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase"
                                                           readonly="readonly" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(city_code)%>"
                                                           name="cit_code" id="cit_code"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <%} else {%>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_city" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">New City</span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           ...
                                                           name="cit_code" id="cit_code" maxlength="8"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
