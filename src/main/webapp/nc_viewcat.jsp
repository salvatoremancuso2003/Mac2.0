        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">Maintenance No Change <small><b>View Category</b></small></h3>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <a href="nc_viewcat.jsp" class="btn btn-outline red" ><i class="fa fa-remove"></i> Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <%
                        ...
                        //ArrayList<NC_category> licateg = Engine.query_nc_category_all(null);
                        //ArrayList<NC_causal> licaus = Engine.query_nc_causal_all(null);
                        ArrayList<NC_category> licateg = Engine.query_nc_category_all(nc_cat1);
                        ArrayList<NC_causal> licaus = Engine.query_nc_causal_all(nc_cat1);
                        ArrayList<String[]> liout = Engine.query_nc_onlycat(Utility.sanitize(licateg), Utility.sanitize(licaus), Utility.sanitize(array_nc_kind));
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <table class="table table-responsive table-bordered table-hover" id="sample_0" width="100%">
                                                            <thead>
                                                                <tr>
                                                                    <th class="tabnow"style="width: 70px;">Branch ID</th>
