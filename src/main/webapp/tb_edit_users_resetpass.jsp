            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <form role="form" id="formreset" name="formreset" method="post" action="Edit?type=reset_pswuser" onsubmit="return checkpass();">
                        <input type="hidden" name="us_code"  value="<%=Utility.sanitize(us.getCod())%>" />
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="tb_edit_users.jsp?us_code=<%=Utility.sanitize(us_code)%>" class="btn btn-outline blue"><i class="fa fa-arrow-circle-o-left"></i> Back</a>
                        </div>
                    </div>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
