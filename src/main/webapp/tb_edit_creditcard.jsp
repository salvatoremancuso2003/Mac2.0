                ...
                <div class="page-content">
                    ...
                    <%
                        ...
                        if (cc_code != null) {
                            ...
                            String status = "";
                            if (Utility.formatAL(cc_code, array_cc, 2).equals("0")) {
                                status = "checked";
                            }
                        ...
                        <div class="row">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View Credit Card - Branch: <%=Utility.sanitize(fil)%></span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase"
                                                           id="cod" name="cod" onkeypress="return keysub(this, event);" maxlength="3" value="<%=Utility.sanitize(cc_code)%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" onkeypress="return keysub(this, event);"
                                                           value="<%=Utility.sanitize(descr)%>" readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <%}else{%>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_credit" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit Credit Card</span>
                                        </div>
                                        <div class="tools"> 
                    ...
                    <%}} else {%>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_credit" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">New Credit Card</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Code</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" id="cod" name="cod" onkeypress="return keysub(this, event);"maxlength="3" > 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
