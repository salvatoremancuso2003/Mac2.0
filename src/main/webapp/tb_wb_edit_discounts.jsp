        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_wb_discount" onsubmit="return checkdescr();">

                        <input type="hidden" name="oldccod" value="<%=Utility.sanitize(va[0])%>" />
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit Discounts</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           id="fi_code" name="fi_code" onkeypress="return keysub(this, event);" value="<%=Utility.sanitize(va[0])%>" maxlength="6" /> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="checkbox" <%=coupon%> class="make-switch"
                                                           id="coupon" name="coupon" onkeypress="return keysub(this, event);"
                                                           data-size="normal" data-on-color="success" data-off-color="danger"
                                                           data-on-text="<span class='tabnow'>YES</span>" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="perc_value" name="perc_value" 
                                                           value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(va[3]))%>"
                                                           onkeypress="return keysub(this, event);"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="euro_value" name="euro_value" 
                                                           onkeypress="return keysub(this, event);"
                                                           value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(va[4]))%>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="sogliaminima" name="sogliaminima" 
                                                           onkeypress="return keysub(this, event);"
                                                           onchange="return formatValueDecimal_length(this, '<%=thousand%>', '<%=decimal%>', 2);"
                                                           value="<%=Utility.formatMysqltoDisplay(Utility.sanitize(va[5]))%>"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control date-picker" id="data_start" name="data_start" 
                                                           onkeypress="return keysub(this, event);"
                                                           value="<%=Utility.sanitize(Utility.formatStringtoStringDate(va[6], Constant.patternsql, Constant.patternnormdate_filter))%>"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control date-picker" id="data_end" name="data_end" 
                                                           onkeypress="return keysub(this, event);"
                                                           value="<%=Utility.sanitize(Utility.formatStringtoStringDate(va[7], Constant.patternsql, Constant.patternnormdate_filter))%>"/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">BUY/SELL</label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2" name="buysell" id="buysell">
                                                        <%
                                                            String selA = va[13].equals("A") ? "selected" : "";
                                                            String selB = va[13].equals("B") ? "selected" : "";
                                                            String selS = va[13].equals("S") ? "selected" : "";
                                                        %>
                                                        <option value="A" <%=selA%>>All</option>
                                                        <option value="B" <%=selB%>>BUY ONLY</option>
                                                        <option value="S" <%=selS%>>SELL ONLY</option>
                                                    </select>
                                                </div>
                                            </div>         
                                            <script type="text/javascript">
                                                function re1() {
                                                    var Accessids = "";
                                                    $("#cumulabile_con option:selected").each(function (i, obj) {
                                                        Accessids = Accessids + $(obj).val() + ";";
                                                    });
                                                    if (Accessids === "---" || Accessids === "---;") {
                                                    } else {
                                                        if (Accessids.includes("---")) {
                                                            $("#cumulabile_con").val("---").change();
                                                        }
                                                    }
                                                }
                                            </script>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Cumulable with</label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2" name="cumulabile_con" id="cumulabile_con" multiple onchange="return re1()">
                                                        <%  String se_none = "";
                                                            if (va[10].contains("---")) {
                                                                se_none = "selected";
                                                            }
                                                        %>
                                                        <option <%=se_none%> value="---">No One</option>
                                                        <%for (int j = 0; j < list_agevolazioni_varie.size(); j++) {
                                                                if (!list_agevolazioni_varie.get(j)[0].equals(code)) {
                                                                    String select = "";
                                                                    if (va[10].contains(list_agevolazioni_varie.get(j)[0])) {
                                                                        select = "selected";
                                                                    }
                                                        %>
                                                        <option <%=select%> value="<%=list_agevolazioni_varie.get(j)[0]%>">
                                                            <%=list_agevolazioni_varie.get(j)[0]%> - <%=list_agevolazioni_varie.get(j)[1]%>
                                                        </option>
                                                        <%}
                                                            }%>
                                                    </select>
                    ...
                    <%} else {%>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_wb_discount" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Add Discounts</span>
                                        </div>
                                        <div class="tools"> 
                                            <button type="submit" class="btn btn-outline blue"><i class="fa fa-save"></i> Save changes</button>
                                        </div>
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Cumulable with</label>
                                                <div class="col-md-9">
                                                    <select class="form-control select2" name="cumulabile_con" id="cumulabile_con" multiple>
                                                        <option value="---">No One</option>
                                                        <%for (int j = 0; j < list_agevolazioni_varie.size(); j++) {%>
                                                        <option value="<%=list_agevolazioni_varie.get(j)[0]%>">
                                                            <%=list_agevolazioni_varie.get(j)[0]%> - <%=list_agevolazioni_varie.get(j)[1]%>
                                                        </option>
                                                        <%}%>
                                                    </select>
