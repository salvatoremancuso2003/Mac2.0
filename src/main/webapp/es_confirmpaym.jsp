                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <b>Code:</b> <%=Utility.sanitize(codtaglio)%>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <b>Brand:</b> <%=Utility.sanitize(bra)%>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <b>Description:</b> <%=Utility.sanitize(desc)%>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <b>Type:</b> <%=Utility.sanitize(tipoprodotto)%>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="kind_1" name="kind_1" placeholder="..."
                                        ...
                                        <option value="<%=Utility.sanitize(array_kind_payment.get(i)[0])%>"><%=Utility.sanitize(array_kind_payment.get(i)[1])%></option>
                                        <%}%>
                                    </select>
                                </div>
                            </div>
