...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Mac2.0 - <%=Constant.eithcettaOS%></title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white" onload="return online();">
        ...
        <div class="page-container">
            <!-- BEGIN MENU -->
            <%@ include file="menu/menu_es5.jsp"%>
            <!-- END MENU -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h3 class="page-title">External Services <small><b><%=Constant.eithcettaOS%></b></small></h3>
                        </div>
                    ...
                    <%if (Constant.is_IT) {%>
                    <%
                        boolean abilita = !Engine.isCentral();
                        if (abilita) {%>
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" 
                                    class="btn btn-outline dark" onclick="return apritangerine();">
                                <i class="fa fa-key"></i> Login <%=Constant.eithcettaOS%></button>
                        </div>
                    </div>
                    <script type="text/javascript">
                        function apritangerine() {
                            $.ajax({
                                type: "POST",
                                url: "Operazioni?type=logintangerine",
