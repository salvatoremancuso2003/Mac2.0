                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">View Safe/Till - Branch: <%=Utility.sanitize(fil)%></span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           value="<%=Utility.sanitize(sa_code)%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" readonly="readonly" value="<%=Utility.sanitize(descr)%>" onkeypress="return keysub(this, event);"> 
                                                </div>
                                            </div>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" 
                                                           name="sa_code" value="<%=Utility.sanitize(sa_code)%>" 
                                                           readonly="readonly"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="descr" name="descr" value="<%=Utility.sanitize(descr)%>" onkeypress="return keysub(this, event);"> 
                                                </div>
                                            </div>
