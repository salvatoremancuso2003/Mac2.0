                        ...
                        jQuery(document).ready(function () {
                            var dt2 = function () {
                                ...
                                g.dataTable({
                                    ...
                                    ajax: {
                                        url: "Query?type=et_list&typeop=<%=Utility.sanitize(request.getParameter("typeop"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&pdf=<%=Utility.sanitize(pdfstr)%>",
                                                            dataSrc: "aaData",
                                                            type: "GET"
                                                        },
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=et_list&typeop=<%=Utility.sanitize(request.getParameter("typeop"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=excel', '_blank');
                                                    }
                                                },
                                                {text: "<i class='fa fa-file-pdf-o'></i> Pdf",
                                                    ...
                                                    action: function (e, dt, node, config) {
                                                        ...
                                                        window.open('Fileview?type=et_list&typeop=<%=Utility.sanitize(request.getParameter("typeop"))%>&branch=<%=Utility.sanitize(request.getParameter("branch"))%>&d1=<%=Utility.sanitize(request.getParameter("d1"))%>&d2=<%=Utility.sanitize(request.getParameter("d2"))%>&value=pdf', '_blank');
                                                    }
                                                },
