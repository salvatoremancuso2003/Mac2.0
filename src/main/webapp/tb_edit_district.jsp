        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="clearfix"></div>
                    <%
                        String district_code = request.getParameter("di_code");

                        if (district_code != null) {
                            ArrayList<String[]> array_district = Engine.district();
                            String descr = Utility.formatAL(district_code, array_district, 1);
                            String idpr = Utility.formatAL(district_code, array_district, 2);
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=edit_district" onsubmit="return checkdescr();">
                        <input type="hidden" name="idpr" value="<%=Utility.sanitize(idpr)%>"/>
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">Edit District</span>
                                        </div>
                                        <div class="tools"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" 
                                                           ...
                                                           value="<%=Utility.sanitize(district_code)%>" 
                                                           readonly="readonly" id="di_code"name="di_code"onkeypress="return keysub(this, event);"> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control"
                                                           value="<%=Utility.sanitize(descr)%>" id="descr"name="descr"onkeypress="return keysub(this, event);"> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <%} else {
                    %>
                    <form class="form-horizontal" role="form" name="f1" method="post" action="Edit?type=ins_newdistrict" onsubmit="return checkdescr();">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- BEGIN PORTLET-->
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-blue bold uppercase">New District</span>
                                        </div>
                                        <div class="tools"> 
                                    ...
                                    <div class="portlet-body">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Code</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control uppercase" id="di_code"name="di_code" onkeypress="return keysub(this, event);">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description</label>
