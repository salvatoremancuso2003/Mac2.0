...
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            ...
            <a target="_blank" href="https://app.documentchecker.com/" class="btn btn-outline btn-icon-only default tooltips" title="Document Checker" data-placement="bottom"><i class="fa fa-hand-o-right"></i></a>
        </li>
    </ul>
</div>