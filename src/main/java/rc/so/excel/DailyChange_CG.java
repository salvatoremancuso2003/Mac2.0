...
public class DailyChange_CG {
    ...
    String AGCODE,AGNUMBER;
    String IBCHAN,CBCOMM;

    public String getIBCHAN() {
        return IBCHAN;
    }

    public void setIBCHAN(String IBCHAN) {
        this.IBCHAN = IBCHAN;
    }

    public String getCBCOMM() {
        return CBCOMM;
    }

    public void setCBCOMM(String CBCOMM) {
        this.CBCOMM = CBCOMM;
    }
