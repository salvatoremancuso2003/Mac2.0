 ...
 * @author srotella
 */
public class CustomerTransactionList_value {
     ...
     * @return
     */
    public ArrayList<CustomerTransactionList_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<CustomerTransactionList_value> dati) {
        this.dati = dati;
    }
