 ...
 * @author srotella
 */
public class FromBranchingSheet_value {
    ...
    ArrayList<FromBranchingSheet_value> dati;
     ...
     * @return
     */
    public ArrayList<FromBranchingSheet_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<FromBranchingSheet_value> dati) {
        this.dati = dati;
    }
