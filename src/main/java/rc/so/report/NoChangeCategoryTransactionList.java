 ...
 * @author fplacanica
 */
public class NoChangeCategoryTransactionList {
     ...
     *
     */
    public static float[] columnWidths2 = new float[]{2f, 5f, 15f, 30f, 30f, 7f, 8f, 8f, 10f, 10f};
    ...
    final String intestazionePdf = "No Change category transaction list";
...
//    public static final String logo = "web/resource/logocl.png";
     ...
     * Costructor
     */
    public NoChangeCategoryTransactionList() {
     ...
     * @return
     */
    public String receipt(String path, ArrayList<NoChangeCategoryTransactionList_value> nctllist, ArrayList<String> colonne, String datereport1, String datereport2) {

        //  String outputfile = "NoChangeCategoryTransactionList.pdf";
        try {
            File pdf = new File(path + generaId(50) + "NoChangeCategoryTransactionList.pdf");
            ...
            for (int w = 0; w < nctllist.size(); w++) {
                ...
                NoChangeCategoryTransactionList_value nctl = nctllist.get(w);
                ...
                // Paragraph pa1 = new Paragraph(new Phrase("From " + datereport1 + "  " + datereport2, f2_normal));
                ...
                //  document.add(table2);
                // document.add(sep);
                ArrayList<NoChangeCategoryTransactionList_value> dati = nctl.getDati();
                PdfPCell cell;
                Phrase phraset;
                PdfPCell cellt;
                ...
                for (int x = 0; x < dati.size(); x++) {
                    NoChangeCategoryTransactionList_value temp = dati.get(x);
                ...
                for (int j = 0; j < category.size(); j++) {
                    ...
                    for (int i = 0; i < dati.size(); i++) {
                        ...
                        NoChangeCategoryTransactionList_value temp = (NoChangeCategoryTransactionList_value) dati.get(i);
                        ...
                        if (temp.getCategoryTrans().equals(category.get(j))) {
                            ...
                            if (temp.getAnnullato().equals("1")) {
                                ...
                                if (!temp.getKindTrans().toLowerCase().contains("acquisto") && !temp.getKindTrans().toLowerCase().contains("buy")) {
                                    ...
                                    totFee += fd(formatDoubleforMysql(temp.getFee()));
                            ...
                            phraset = new Phrase();
                            phraset.add(new Chunk(temp.getFee(), f3_normal));
                            cellt = new PdfPCell(phraset);
                            cellt.setHorizontalAlignment(ALIGN_RIGHT);
                            cellt.setBorder(BOTTOM);
                            table3.addCell(cellt);
                            ...
                            phraset = new Phrase();
                            phraset.add(new Chunk((temp.getDetails()), f3_normal));
                            cellt = new PdfPCell(phraset);
                            cellt.setHorizontalAlignment(ALIGN_LEFT);
                            cellt.setBorder(BOTTOM);
                            table3.addCell(cellt);
                    ...
                    phraset = new Phrase();
                    phraset.add(new Chunk(formatMysqltoDisplay(roundDoubleandFormat(totFee, 2)), f4_bold));
                    cellt = new PdfPCell(phraset);
                    cellt.setHorizontalAlignment(ALIGN_RIGHT);
                    cellt.setBorder(BOTTOM);
                    table5.addCell(cellt);
                    ...
                    if ((availableSpace < 120) || j == category.size() - 1) {
                ...
                phraset = new Phrase();
                phraset.add(new Chunk(formatMysqltoDisplay(roundDoubleandFormat(totFeeTot, 2)), f4_bold));
                cellt = new PdfPCell(phraset);
                cellt.setHorizontalAlignment(ALIGN_RIGHT);
                cellt.setBorder(BOTTOM);
                table4.addCell(cellt);
     ...
     * @return
     */
    public String receiptexcel(String path, ArrayList<NoChangeCategoryTransactionList_value> nctllist, ArrayList<String> colonne, String datereport1, String datereport2) {
...
//            cl2.setCellValue(datereport1);
                ...
                for (int j = 0; j < category.size(); j++) {
                        ...
                        if (temp.getCategoryTrans().equals(category.get(j))) {
                            ...
                            if (temp.getAnnullato().equals("1")) {
                                ...
                                if (!temp.getKindTrans().toLowerCase().contains("acquisto") && !temp.getKindTrans().toLowerCase().contains("buy")) {
                                    totParz += fd(formatDoubleforMysql(temp.getTotal()));
                                    totFee += fd(formatDoubleforMysql(temp.getFee()));
                                    totParzQuantity += ff(formatDoubleforMysql(temp.getQuantity()));
                                }
                            ...
                            f5.setCellValue(temp.getNote());

                            Cell f6 = row6.createCell(6, NUMERIC);
                            f6.setCellStyle(cellStylenumint);
                            f6.setCellValue(fd(formatDoubleforMysql(temp.getQuantity())));

                            Cell f7 = row6.createCell(7, NUMERIC);
                            f7.setCellStyle(cellStylenum);
                            f7.setCellValue(fd(formatDoubleforMysql(temp.getTotal())));

                            Cell f7b = row6.createCell(8, NUMERIC);
                            f7b.setCellStyle(cellStylenum);
                            f7b.setCellValue(fd(formatDoubleforMysql(temp.getFee())));

                            Cell f8 = row6.createCell(9);
                            f8.setCellStyle(style4left);
                            
                            f8.setCellValue(temp.getDetails());
                    ...
                    f19.setCellValue(fd(roundDoubleandFormat(totParzQuantity, 0)) );

                    tot += totParz;
                    totFeeTot += totFee;
                    totQuantity += totParzQuantity;

                    Cell f19bis = row7.createCell(7);
                    f19bis.setCellStyle(style3num);
                    f19bis.setCellValue(fd(roundDoubleandFormat(totParz, 2)));

                    Cell f19bis1 = row7.createCell(8);
                    f19bis1.setCellStyle(style3num);
                    f19bis1.setCellValue(fd(roundDoubleandFormat(totFee, 2)));
                ...
                f20.setCellStyle(style3left);
                f20.setCellValue("Total from transaction listed");

                Cell f19 = row8.createCell(6);
                f19.setCellStyle(style3numint);
                f19.setCellValue(fd(roundDoubleandFormat(totQuantity, 0)) + "");

                Cell f19bis = row8.createCell(7);
                f19bis.setCellStyle(style3num);
                f19bis.setCellValue(fd(roundDoubleandFormat(tot, 2)));

                Cell f19bis2 = row8.createCell(8);
                f19bis2.setCellStyle(style3num);
                f19bis2.setCellValue(fd(roundDoubleandFormat(totFeeTot, 2)));
