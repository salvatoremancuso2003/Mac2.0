 ...
 * @author srotella
 */
public class TillTransactionList_value {

    ArrayList<TillTransactionList_value> dati;
     ...
     * @return
     */
    public ArrayList<TillTransactionList_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<TillTransactionList_value> dati) {
        this.dati = dati;
    }
