 ...
 */
public class NoChangeInternalTransferList {
    ...
    final String intestazionePdf = "No Change \n Internal Transfer List";
...
//    public static final String logo = "web/resource/logocl.png";
     ...
     * Costructor
     */
    public NoChangeInternalTransferList() {
     ...
     * @return
     */
    public String receipt(String path,NoChangeInternalTransferList_value siq, ArrayList<String> colonne,String datereport) {

        String outputfile = "NoChangeInternalTransfertList.pdf";
        ...
        for (int c = 0; c < colonne.size(); c++) {
            if (c == 0 || c == 1) {
                columnWidths2[c] = 8f;
            } else if (c == colonne.size() - 2 || c == colonne.size() - 1 || c == colonne.size() - 3) {
                columnWidths2[c] = 8f;
            } else {
                columnWidths2[c] = 20f;
            }
        ...
        try {
            ...
            try(OutputStream ou = new FileOutputStream(outputfile)){
            ...
            //Paragraph pa1 = new Paragraph(new Phrase("Selected Interval " + datereport, f2_normal));
            ...
            phrase4.add(new Chunk("", f5_normal));
            ...
            //  document.add(table2);
            //  document.add(sep);
            ArrayList<NoChangeInternalTransferList_value> dati = siq.getDati();
            ...
            for (int i = 0; i < dati.size(); i++) {
               NoChangeInternalTransferList_value temp = dati.get(i);
