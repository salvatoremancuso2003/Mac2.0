 ...
 * @author vcrugliano
 */
public class FromBranchingSheet {
    ...
    final String intestazionePdf = "From Branching Sheet";
...
//    public static final String logo = "web/resource/logocl.png";
    ...
    public String receipt(String path, FromBranchingSheet_value siq, ArrayList<String> colonne, String datereport,
            ArrayList<String> colonne2, ArrayList<NoChangeFromBranchingSheet_value> dati2) {
