 ...
 * @author srotella
 */
public class ToBranchingSheetReceipt_value {
    ...
    ArrayList<ToBranchingSheetReceipt_value> dati;
     ...
     * @return
     */
    public ArrayList<ToBranchingSheetReceipt_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<ToBranchingSheetReceipt_value> dati) {
        this.dati = dati;
    }
