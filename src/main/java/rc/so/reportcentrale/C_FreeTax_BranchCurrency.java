 ...
 * @author fplacanica
 */
public class C_FreeTax_BranchCurrency {
    ...
    final String intestazionePdf = "VAT Refund -  Branch & Currency";
...
//    public static final String logo = "web/resource/logocl.png";
     ...
     ** Constructor
     */
    public C_FreeTax_BranchCurrency() {
     ...
     * @return
     */
    public Document receipt(C_FreeTax_BranchCurrency_value cmfb, ArrayList<String> colonne, boolean firstTime, boolean lastTime, Document document) {
        ...
        try {
            ...
            ArrayList<C_FreeTax_BranchCurrency_value> dati = cmfb.getDati();
            ...
            if (ft) {
                ...
                phraset = new Phrase();
                phraset.add(new Chunk(cmfb.getBranch(), f4_bold));
...
//                
                C_FreeTax_BranchCurrency_value temp = dati.get(j);
            ...
            if (lastTime) {
                ...
                if (totaleEUROqtyPrevYear > 0 && totaleEUROqtyYear > 0) {
                    phraset.add(new Chunk(formatMysqltoDisplay(roundDoubleandFormat((totaleEUROtotVolVal / totaleEUROqtyPrevYear) * 100, 2)) + "", f4_bold));
                } else {
                    phraset.add(new Chunk("0,00", f4_bold));
                }
                cellt = new PdfPCell(phraset);
    ...
    public String main(String path, String d3, String d4,
        ...
        try {
            C_FreeTax_BranchCurrency nctl = new C_FreeTax_BranchCurrency();

            C_FreeTax_BranchCurrency_value pdf = new C_FreeTax_BranchCurrency_value();

            boolean firstTime = true;
            boolean lastTime = false;

            File pdffile = new File(path + generaId(50) + "C_FreeTax_BranchCurrency.pdf");
            ...
            for (int i = 0; i < filiali.size(); i++) {
                ...
                ArrayList<C_FreeTax_BranchCurrency_value> dati = dbm.list_C_FreeTax_BranchCurrency_value(filiali.get(i), data1, data2, br);
                if (dati.size() > 0) {
                    find = true;
                }
                ...
                pdf.setDataA(d4);
                pdf.setDati(dati);
                pdf.setBranch(formatBankBranch(filiali.get(i), "BR", null, br, null));
//
//       
                if (i == filiali.size() - 1) {
                    lastTime = true;
...
//                
    ...
    public String mainexcel(String path, String d3, String d4,
            ...
            ArrayList<String> alcolonne, ArrayList<String> filiali, ArrayList<Branch> br) {
        try {
            File pdffile = new File(path + generaId(50) + "C_VatRefund_BranchCurrency.xls");
            HSSFWorkbook workbook = new HSSFWorkbook();
            HSSFSheet sheet = workbook.createSheet("C_VatRefund_BranchCurrency");
