 ...
 * @author srotella
 */
public class C_FreeTax_BranchCurrency_value {
    
    
    String id_filiale, de_filiale,dataDa,dataA;

    String currency, branch, volPrevYear, volYear, volVal, volPerc, qtyPrevYear, qtyYear, qtyVal, qtyPerc;
    
    boolean valuta;
    
    ArrayList<C_FreeTax_BranchCurrency_value> dati;
     ...
     * @return
     */
    public ArrayList<C_FreeTax_BranchCurrency_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<C_FreeTax_BranchCurrency_value> dati) {
        this.dati = dati;
    }
