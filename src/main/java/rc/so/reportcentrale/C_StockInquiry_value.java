 ...
 * @author srotella
 */
public class C_StockInquiry_value {
    
    String id_filiale, de_filiale, till, currency ,notes ,eurotravelcheques, travelcheques, creditcard, personalcheques, creditcardCOP, bancomatCOP, date;
    int columnnumber;
