 ...
 * @author srotella
 */
public class C_FreeTax_Analisys_value implements Comparable<C_FreeTax_Analisys_value>{
    
    
    String id_filiale, de_filiale,dataDa,dataA;

    String causal, volPrevYear, volYear, volVal, volPerc, qtyPrevYear, qtyYear, qtyVal, qtyPerc;
    ...
    ArrayList<C_FreeTax_Analisys_value> dati;
     ...
     * @return
     */
    public ArrayList<C_FreeTax_Analisys_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<C_FreeTax_Analisys_value> dati) {
        this.dati = dati;
    }
