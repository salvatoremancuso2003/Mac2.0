 ...
 * @author srotella
 */
public class C_FreeTax_AmountBranch_value {
    ...
    ArrayList<C_FreeTax_AmountBranch_value> dati;
     ...
     * @return
     */
    public ArrayList<C_FreeTax_AmountBranch_value> getDati() {
        return dati;
    }
     ...
     * @param dati
     */
    public void setDati(ArrayList<C_FreeTax_AmountBranch_value> dati) {
        this.dati = dati;
    }
